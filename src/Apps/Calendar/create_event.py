...
from .calendar_service import get_service # Relative import works if running from api_server

def create_new_event(summary, start_time_iso, duration_hours=1, description=None):
    """
    Creates a new event.
    ...
    try:
        ...
        print(f"✅ Created: {summary} ({event.get('htmlLink')})")
        return event
