...
def get_github_file_content_tool(repo_name: str, path: str, username: str = None, branch: str = None) -> str:
    ...
    try:
        from src.CoreFunctions.Integrations.Github.github_ops import get_github_file_content
...
get_github_file_content = StructuredTool.from_function(
    func=get_github_file_content_tool,
