...
def get_github_recent_activity_tool(username: str = None, count: int = 5, include_private: bool = True) -> str:
    ...
    try:
        from src.CoreFunctions.Integrations.Github.github_ops import get_github_recent_activity
...
get_github_recent_activity = StructuredTool.from_function(
    func=get_github_recent_activity_tool,
    name="get_github_recent_activity",
