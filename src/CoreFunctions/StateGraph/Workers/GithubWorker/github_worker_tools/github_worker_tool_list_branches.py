...
def list_github_branches_tool(repo_name: str, username: str = None) -> str:
    ...
    try:
        from src.CoreFunctions.Integrations.Github.github_ops import list_github_branches
        res = list_github_branches(repo_name, username=username)
        return json.dumps(res, indent=2)
    except Exception as e:
        return f"Error listing branches: {e}"

list_github_branches = StructuredTool.from_function(
    func=list_github_branches_tool,
