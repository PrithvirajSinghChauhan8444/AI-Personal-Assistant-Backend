...
def search_github_code_tool(query: str, username: str = None, repo_name: str = None, page: int = 1, count: int = 10) -> str:
    ...
    try:
        from src.CoreFunctions.Integrations.Github.github_ops import search_github_code
...
search_github_code = StructuredTool.from_function(
    func=search_github_code_tool,
