...
def mark_emails_as_unread(
    ...
    """Mark a batch of emails as unread by adding the 'UNREAD' label.
    ...
    Args:
        ...
        message_ids (list, optional): List of specific email IDs to mark as unread.
    ...
    """
    print(f"\n[DEBUG] 🛠️ Calling Tool: mark_emails_as_unread")
    target_ids = []
    ...
    try:
        ...
        return json.dumps({
            ...
            "marked_unread_ids": target_ids
        }, indent=2)

    except Exception as e:
        return f"Error marking emails as unread: {e}"

gmail_worker_tool_mark_emails_as_unread = StructuredTool.from_function(
    func=mark_emails_as_unread,
    name="mark_emails_as_unread",
    description="Mark a batch of emails as unread by adding the 'UNREAD' label."
)
