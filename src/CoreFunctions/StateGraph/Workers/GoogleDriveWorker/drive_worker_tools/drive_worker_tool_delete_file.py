...
def delete_drive_file_tool(file_id: str, account: str = "personal") -> str:
    ...
    try:
        from src.CoreFunctions.Integrations.GoogleDrive.drive_ops import delete_drive_file
        return delete_drive_file(file_id, account=account)
    except Exception as e:
        return f"Error trashing file: {e}"

delete_drive_file_tool = StructuredTool.from_function(
    func=delete_drive_file_tool,
    name="delete_drive_file_tool",
