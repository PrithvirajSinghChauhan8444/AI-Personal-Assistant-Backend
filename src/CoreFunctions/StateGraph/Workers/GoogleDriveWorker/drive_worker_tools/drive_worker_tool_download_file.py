...
def download_drive_file_tool(file_id: str, local_path: str, account: str = "personal") -> str:
    ...
    try:
        from src.CoreFunctions.Integrations.GoogleDrive.drive_ops import download_drive_file
        return download_drive_file(file_id, local_path, account=account)
    except Exception as e:
        return f"Error downloading file: {e}"

download_drive_file_tool = StructuredTool.from_function(
    func=download_drive_file_tool,
    name="download_drive_file_tool",
