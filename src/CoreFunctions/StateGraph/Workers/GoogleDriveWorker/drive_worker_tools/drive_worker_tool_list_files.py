...
def list_drive_files_tool(query: str = None, limit: int = 10, account: str = "personal") -> str:
    ...
    try:
        from src.CoreFunctions.Integrations.GoogleDrive.drive_ops import list_drive_files
        res = list_drive_files(query, limit, account=account)
        return json.dumps(res, indent=2)
    except Exception as e:
        return f"Error listing files: {e}"

list_drive_files_tool = StructuredTool.from_function(
    func=list_drive_files_tool,
    name="list_drive_files_tool",
