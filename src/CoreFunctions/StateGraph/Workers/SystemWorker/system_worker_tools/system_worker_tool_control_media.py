...
def control_media_player(action: str) -> str:
    ...
    try:
        from src.CoreFunctions.Integrations.System.system_actions import media_control
        return media_control(action)
    except Exception as e:
        return f"Error: {e}"

control_media_player = StructuredTool.from_function(
    func=control_media_player,
