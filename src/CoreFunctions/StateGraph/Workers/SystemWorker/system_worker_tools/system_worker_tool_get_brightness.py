...
def get_screen_brightness() -> str:
    ...
    try:
        from src.CoreFunctions.Integrations.System.system_actions import get_brightness
        return get_brightness()
    except Exception as e:
        return f"Error: {e}"

get_screen_brightness = StructuredTool.from_function(
    func=get_screen_brightness,
