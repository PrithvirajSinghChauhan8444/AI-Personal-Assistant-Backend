...
def index_directory_tool(path: str) -> str:
    ...
    from src.CoreFunctions.Infrastructure.file_vector_store import index_directory_recursive
    return index_directory_recursive(path)

index_directory_tool = StructuredTool.from_function(
    func=index_directory_tool,
    name="index_directory_tool",
