...
def list_running_processes_tool(limit: int = 15) -> str:
    ...
    try:
        from src.CoreFunctions.Integrations.System.system_actions import list_processes
        return list_processes(limit)
    except Exception as e:
        return f"Error: {e}"

list_running_processes_tool = StructuredTool.from_function(
    func=list_running_processes_tool,
