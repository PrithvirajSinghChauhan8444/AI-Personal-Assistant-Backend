...
def lock_desktop_screen() -> str:
    ...
    try:
        from src.CoreFunctions.Integrations.System.system_actions import lock_screen
        return lock_screen()
    except Exception as e:
        return f"Error: {e}"

lock_desktop_screen = StructuredTool.from_function(
    func=lock_desktop_screen,
    name="lock_desktop_screen",
