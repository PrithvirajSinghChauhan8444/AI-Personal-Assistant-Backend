...
def mute_audio_toggle() -> str:
    ...
    try:
        from src.CoreFunctions.Integrations.System.system_actions import toggle_mute
        return toggle_mute()
    except Exception as e:
        return f"Error: {e}"

mute_audio_toggle = StructuredTool.from_function(
    func=mute_audio_toggle,
    name="mute_audio_toggle",
