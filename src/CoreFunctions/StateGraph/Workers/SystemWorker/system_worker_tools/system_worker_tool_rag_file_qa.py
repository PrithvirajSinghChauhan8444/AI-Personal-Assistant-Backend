...
def rag_file_qa_tool(query: str, filepath: str) -> str:
    ...
    from src.CoreFunctions.Infrastructure.file_vector_store import rag_qa_file
    return rag_qa_file(query, filepath)

rag_file_qa_tool = StructuredTool.from_function(
    func=rag_file_qa_tool,
    name="rag_file_qa_tool",
