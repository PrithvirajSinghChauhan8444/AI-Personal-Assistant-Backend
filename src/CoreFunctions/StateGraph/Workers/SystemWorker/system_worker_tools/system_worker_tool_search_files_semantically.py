...
def search_files_semantically_tool(query: str, limit: int = 5) -> str:
    ...
    from src.CoreFunctions.Infrastructure.file_vector_store import search_files_semantically
    return search_files_semantically(query, limit)

search_files_semantically_tool = StructuredTool.from_function(
    func=search_files_semantically_tool,
    name="search_files_semantically_tool",
