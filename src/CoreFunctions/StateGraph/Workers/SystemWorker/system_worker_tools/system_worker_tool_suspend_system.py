...
def suspend_desktop_system() -> str:
    ...
    if verify_password():
        try:
            from src.CoreFunctions.Integrations.System.system_actions import suspend_system
            return suspend_system()
        except Exception as e:
            return f"Error: {e}"
    return "❌ Action Cancelled: Incorrect Password."

suspend_desktop_system = StructuredTool.from_function(
    func=suspend_desktop_system,
    name="suspend_desktop_system",
