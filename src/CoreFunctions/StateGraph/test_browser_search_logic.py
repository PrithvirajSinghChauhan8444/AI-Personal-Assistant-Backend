...
def run_test():
    print("🚀 Running StateGraph BrowserWorker Search Logic Test...")
    print("\n--- Initiating Graph Run (Goal: Find and read OpenAI's latest blog titles without a starting URL) ---")
    
    initial_state = {
        "primary_goal": "Find OpenAI's official blog page and tell me the titles of their latest blog posts.",
        "active_subtasks": [],
        "working_memory": {},
        "completed_tasks": {},
        "final_response": ""
    ...
    config = {"configurable": {"thread_id": "test_browser_search_session"}}
