...
def test_ambiguous_email():
    print("🚀 Running Live Ambiguity Task Routing Test...")
    goal = "Send an email to Rohan saying I will be late."

    initial_state = {
        "primary_goal": goal,
        "active_subtasks": [],
        "working_memory": {
            # Inject context containing multiple Rohans to force ambiguity
            "user_profile": {
                "rohan_brother": "rohan.brother@example.com",
                "rohan_colleague": "rohan.colleague@work.com"
            },
            "relevant_memories": [
                "I have a brother named Rohan.",
                "Rohan from my office is my manager."
            ]
        },
        "completed_tasks": {},
        "final_response": "",
    ...
    config = {"configurable": {"thread_id": "manual_verify_confidence"}}
